...
CREATE DATABASE IF NOT EXISTS `peachtrees` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `peachtrees`;
...
-- 正在导出表  peachtrees.pt_options 的数据：~4 rows (大约)
...
-- 导出  表 peachtrees.pt_page_style 结构
...
-- 正在导出表  peachtrees.pt_page_style 的数据：~2 rows (大约)
...
INSERT INTO `pt_posts` (`id`, `tag`, `post_type`, `page_style`, `title`, `slug`, `summary`, `cover_media`, `content`, `allow_comments`, `active`, `created_at`, `updated_at`) VALUES
	(1, 'news', 'normal', '01', '欢迎使用 PeachtreesCMS', NULL, '', '[]', '<p>这是一个 PHP 内容管理系统。</p>', 1, 1, '2026-03-24 17:18:51', '2026-06-11 22:45:56'),
	(2, 'tech', 'normal', NULL, '系统功能介绍', NULL, '', NULL, '<p>系统支持以下功能：</p><ul><li>文章管理</li><li>分类标签</li><li>用户管理</li><li>RSS 订阅</li></ul>', 1, 1, '2026-03-24 17:18:51', '2026-03-24 17:18:51');
...
-- 正在导出表  peachtrees.pt_themes 的数据：~2 rows (大约)
...
-- 正在导出表  peachtrees.pt_users 的数据：~1 rows (大约)
INSERT INTO `pt_users` (`id`, `username`, `email`, `password_hash`, `created_at`, `last_login_at`) VALUES
	(1, 'admin', 'admin@peachtrees.com', '$2y$12$YBnqh4Wjt6sEqYZkaKb7LOqx.k460jVm5aasKSwAQdfSAOSylGPLm', '2026-03-24 17:18:51', '2026-06-11 21:54:48');
